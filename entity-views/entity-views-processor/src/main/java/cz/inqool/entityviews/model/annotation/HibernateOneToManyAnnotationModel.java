...
public class HibernateOneToManyAnnotationModel extends AnnotationModel {
    ...
    public HibernateOneToManyAnnotationModel(TypeModel type, String targetEntity, Map<String, Object> attributes, String[] views) {
    ...
    public static AnnotationModel of(TypeModel typeModel, Map<String, Object> attributes, String[] views) {
        ...
        if (targetEntity != null) {
            return new HibernateOneToManyAnnotationModel(typeModel, targetEntity.replace(".class", ""), attributes, views);
        } else {
            return new AnnotationModel(typeModel, attributes, views);
        }
    }
