...
@Getter
@Setter
public class HibernateOneToOneAnnotationModel extends AnnotationModel {

    private ClassType targetEntity;

    public HibernateOneToOneAnnotationModel(TypeModel type, ClassType targetEntity, Map<String, Object> attributes, String[] views) {
    ...
    public static AnnotationModel of(TypeModel typeModel, Map<String, Object> attributes, Map<MethodSymbol, Attribute> elementValues, String[] views) {
        ...
        if (targetEntity.getValue() instanceof ClassType) {
            ...
            return new HibernateOneToOneAnnotationModel(typeModel, schema, attributes, views);
        } else {
