...
public class ServerPayloadValidatingInterceptor extends PayloadValidatingInterceptor {
    ...
    protected boolean handleRequestValidationErrors(MessageContext messageContext, SAXParseException[] errors) {
        ...
        if (logger.isDebugEnabled()) {
            ...
            logger.debug("Invalid server request body: \n" + soapBody + "\n");
        }
    ...
    protected boolean handleResponseValidationErrors(MessageContext messageContext, SAXParseException[] errors) {
        ...
        if (logger.isDebugEnabled()) {
            ...
            logger.debug("Invalid server response body: \n" + soapBody + "\n");
        }
