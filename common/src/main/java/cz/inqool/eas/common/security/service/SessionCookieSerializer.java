...
/**
 * Copy of {@link DefaultCookieSerializer} with added method to serialize sessionId to {@link org.springframework.http.HttpHeaders}.
 */
public class SessionCookieSerializer implements CookieSerializer {
    ...
    public void writeCookieToHeaders(String sessionId, HttpHeaders headers) {

        StringBuilder sb = new StringBuilder();
        sb.append(this.cookieName).append('=');


        String sessionIdEncoded = Base64.getEncoder().encodeToString(sessionId.getBytes());
        headers.add("Cookie", "SESSION=" + sessionIdEncoded );
    }
