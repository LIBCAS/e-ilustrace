...
/**
 * Copy of {@link FormLoginConfigurer} with exposed authentication filter.
 *
 * @author Rob Winch
...
public class FormLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
     ...
     */
    public FormLoginConfigurer<H> authenticationFilter(UsernamePasswordAuthenticationFilter filter) {
        setAuthenticationFilter(filter);
        return this;
    }
